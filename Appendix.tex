...
\begin{align}
  X^{pq^{J}}_{rs^{J}} &= \sum_{\mathclap{ \{ m \} }} X \braket{pq}{J}\braket{rs}{J} \notag \\
  &= \sum_{\mathclap{ \{ m \} }} X \braket{qp}{J}\braket{rs}{J}(-1)^{j_{p}+j_{q}-J}\ \hspace{0.5cm} \eqref{eq:cgc2}  \notag \\
...
The matrix-matrix expressions that 
  
\begin{flalign}
  &= \sum_{\mathclap{J'M'}}t_{i\overline{a},J'}^{b\overline{j},J'}\mathop{\langle b_{m_{b}}j_{-m_{j}}|J'_{M'}\rangle}\mathop{\langle i_{m_{i}}a_{-m_{a}}|J'_{M'}\rangle}\mathop{\left( -1\right)^{j-m_{j}+a-m_{a}}}\mathop{\{ b_{m_{b}}^{\dagger}j_{m_{j}}a_{m_{a}}^{\dagger}i_{m_{i}}\} } \notag \\[-0.2cm]
  &\hspace{1cm}= \sum_{\mathclap{J'JM}}t_{i\overline{a},J'}^{b\overline{j},J'}\hat{J'}^{2}\sixj{b}{a}{J}{i}{j}{J'}\mathop{\left( -1\right)^{a+b-J}}\mathop{\langle a_{m_{a}}b_{m_{b}}|J_{M}\rangle}\mathop{\langle i_{m_{i}}j_{m_{j}}|J_{M}\rangle}\mathop{\{ a_{m_{a}}^{\dagger}b_{m_{b}}^{\dagger}j_{m_{j}}i_{m_{i}}\} } \notag \\[0.3cm]
  &= \sum_{\mathclap{J'M'}}t_{j\overline{b},J'}^{a\overline{i},J'}\mathop{\langle a_{m_{a}}i_{-m_{i}}|J'_{M'}\rangle}\mathop{\langle j_{m_{j}}b_{-m_{b}}|J'_{M'}\rangle}\mathop{\left( -1\right)^{i-m_{i}+b-m_{b}}}\mathop{\{ a_{m_{a}}^{\dagger}i_{m_{i}}b_{m_{b}}^{\dagger}j_{m_{j}}\} } \notag \\[-0.2cm]
  &\hspace{1cm}= \sum_{\mathclap{J'JM}}t_{j\overline{b},J'}^{a\overline{i},J'}\hat{J'}^{2}\sixj{a}{b}{J}{j}{i}{J'}\mathop{\left( -1\right)^{i+j-J}}\mathop{\langle a_{m_{a}}b_{m_{b}}|J_{M}\rangle}\mathop{\langle i_{m_{i}}j_{m_{j}}|J_{M}\rangle}\mathop{\{ a_{m_{a}}^{\dagger}b_{m_{b}}^{\dagger}j_{m_{j}}i_{m_{i}}\} } \notag \\[0.3cm]
  &= \sum_{\mathclap{J'M'}}t_{i\overline{b},J'}^{a\overline{j},J'}\mathop{\langle a_{m_{a}}j_{-m_{j}}|J'_{M'}\rangle}\mathop{\langle i_{m_{i}}b_{-m_{b}}|J'_{M'}\rangle}\mathop{\left( -1\right)^{j-m_{j}+b-m_{b}}}\mathop{\{ a_{m_{a}}^{\dagger}j_{m_{j}}b_{m_{b}}^{\dagger}i_{m_{i}}\} } \notag \\[-0.2cm]
  &\hspace{1cm}= -\sum_{\mathclap{J'JM}}t_{i\overline{b},J'}^{a\overline{j},J'}\hat{J'}^{2}\sixj{a}{b}{J}{i}{j}{J'}\mathop{\langle a_{m_{a}}b_{m_{b}}|J_{M}\rangle}\mathop{\langle i_{m_{i}}j_{m_{j}}|J_{M}\rangle}\mathop{\{ a_{m_{a}}^{\dagger}b_{m_{b}}^{\dagger}j_{m_{j}}i_{m_{i}}\} } \notag \\[0.3cm]
  &= \sum_{\mathclap{J'M'}}t_{j\overline{a},J'}^{b\overline{i},J'}\mathop{\langle b_{m_{b}}i_{-m_{i}}|J'_{M'}\rangle}\mathop{\langle j_{m_{j}}a_{-m_{a}}|J'_{M'}\rangle}\mathop{\left( -1\right)^{i-m_{i}+a-m_{a}}}\mathop{\{ b_{m_{b}}^{\dagger}i_{m_{i}}a_{m_{a}}^{\dagger}j_{m_{j}}\} } \notag \\[-0.2cm]
  &\hspace{1cm}= -\sum_{\mathclap{J'JM}}t_{j\overline{a},J'}^{b\overline{i},J'}\hat{J'}^{2}\sixj{b}{a}{J}{j}{i}{J'}\mathop{\left( -1\right)^{i+j+a+b}}\mathop{\langle a_{m_{a}}b_{m_{b}}|J_{M}\rangle}\mathop{\langle i_{m_{i}}j_{m_{j}}|J_{M}\rangle}\mathop{\{ a_{m_{a}}^{\dagger}b_{m_{b}}^{\dagger}j_{m_{j}}i_{m_{i}}\} } \notag \\[0.3cm]
  &= \sum_{\mathclap{JM}}t_{i,J}^{ab\overline{j}}\mathop{\langle a_{m_{a}}b_{m_{b}}|J_{M}\rangle}\mathop{\langle J_{M}j_{-m_{j}}|i_{m_{i}}\rangle}\mathop{\left( -1\right) ^{j-m_{j}}}\mathop{\{ a_{m_{a}}^{\dagger}b_{m_{b}}^{\dagger}j_{m_{j}}i_{m_{i}}\} } \notag \\[-0.2cm]
  &\hspace{1cm}= \sum_{\mathclap{JM}}t_{i,J}^{ab\overline{j}}\frac{\hat{i}}{\hat{J}}\mathop{\left( -1\right)^{i+j-J}}\mathop{\langle a_{m_{a}}b_{m_{b}}|J_{M}\rangle}\mathop{\langle i_{m_{i}}j_{m_{j}}|J_{M}\rangle}\mathop{\{ a_{m_{a}}^{\dagger}b_{m_{b}}^{\dagger}j_{m_{j}}i_{m_{i}}\} } \notag \\[0.3cm]
  &= \sum_{\mathclap{JM}}t_{j,J}^{ab\overline{i}}\mathop{\langle a_{m_{a}}b_{m_{b}}|J_{M}\rangle}\mathop{\langle J_{M}i_{-m_{i}}|j_{m_{j}}\rangle}\mathop{\left( -1\right) ^{i-m_{i}}}\mathop{\{ a_{m_{a}}^{\dagger}b_{m_{b}}^{\dagger}i_{m_{i}}j_{m_{j}}\} } \notag \\[-0.2cm]
  &\hspace{1cm}= -\sum_{\mathclap{JM}}t_{j,J}^{ab\overline{i}}\frac{\hat{j}}{\hat{J}}\mathop{\langle a_{m_{a}}b_{m_{b}}|J_{M}\rangle}\mathop{\langle i_{m_{i}}j_{m_{j}}|J_{M}\rangle}\mathop{\{ a_{m_{a}}^{\dagger}b_{m_{b}}^{\dagger}j_{m_{j}}i_{m_{i}}\} } \notag \\[0.3cm]
  &= \sum_{\mathclap{JM}}t_{ij\overline{b}}^{a,J}\mathop{\langle J_{M}b_{-m_{b}}|a_{m_{a}}\rangle}\mathop{\langle i_{m_{i}}j_{m_{j}}|J_{M}\rangle}\mathop{\left( -1\right) ^{b-m_{b}}}\mathop{\{ a_{m_{a}}^{\dagger}b_{m_{b}}^{\dagger}j_{m_{j}}i_{m_{i}}\} } \notag \\[-0.2cm]
  &\hspace{1cm}= \sum_{\mathclap{JM}}t_{ij\overline{b}}^{a,J}\frac{\hat{a}}{\hat{J}}\mathop{\left( -1\right)^{a+b-J}}\mathop{\langle a_{m_{a}}b_{m_{b}}|J_{M}\rangle}\mathop{\langle i_{m_{i}}j_{m_{j}}|J_{M}\rangle}\mathop{\{ a_{m_{a}}^{\dagger}b_{m_{b}}^{\dagger}j_{m_{j}}i_{m_{i}}\} } \notag \\[0.3cm]
  &= \sum_{\mathclap{JM}}t_{ij\overline{a}}^{b,J}\mathop{\langle J_{M}a_{-m_{a}}|b_{m_{b}}\rangle}\mathop{\langle i_{m_{i}}j_{m_{j}}|J_{M}\rangle}\mathop{\left( -1\right) ^{a-m_{a}}}\mathop{\{ b_{m_{b}}^{\dagger}a_{m_{a}}^{\dagger}j_{m_{j}}i_{m_{i}}\} } \notag \\[-0.2cm]
  &\hspace{1cm}= -\sum_{\mathclap{JM}}t_{ij\overline{a}}^{b,J}\frac{\hat{b}}{\hat{J}}\mathop{\langle a_{m_{a}}b_{m_{b}}|J_{M}\rangle}\mathop{\langle i_{m_{i}}j_{m_{j}}|J_{M}\rangle}\mathop{\{ a_{m_{a}}^{\dagger}b_{m_{b}}^{\dagger}j_{m_{j}}i_{m_{i}}\} } \notag
\end{flalign}
