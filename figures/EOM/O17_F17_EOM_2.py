...
filename1 = '/home/sam/Documents/thesis/data/17O_levels.dat'
filename2 = '/home/sam/Documents/thesis/data/PA_final_8_9.dat'
...
filename3 = '/home/sam/Documents/thesis/data/17F_levels.dat'
filename4 = '/home/sam/Documents/thesis/data/PA_final_9_8.dat'
...
ax1.plot([xa[0][1], xa[1][0]], [e2[0][0], e2[1][0]], linestyle=':', color='g', linewidth=1.65)
ax1.plot([xa[1][1], xa[3][0]], [e2[1][0], e1[0]], linestyle=':', color='g', linewidth=1.65)

ax1.plot([xa[0][1], xa[1][0]], [e2[0][1], e2[1][1]], linestyle=':', color='b', linewidth=1.65)
ax1.plot([xa[1][1], xa[3][0]], [e2[1][1], e1[1]], linestyle=':', color='b', linewidth=1.65)
...
ax1.axis([-13.0, 15.0, -0.5, 9.0], fontsize=18)
...
ax2.plot([xa[0][1], xa[1][0]], [e4[0][0], e4[1][0]], linestyle=':', color='g', linewidth=1.65)
ax2.plot([xa[1][1], xa[3][0]], [e4[1][0], e3[0]], linestyle=':', color='g', linewidth=1.65)

ax2.plot([xa[0][1], xa[1][0]], [e4[0][1], e4[1][1]], linestyle=':', color='b', linewidth=1.65)
ax2.plot([xa[1][1], xa[3][0]], [e4[1][1], e3[1]], linestyle=':', color='b', linewidth=1.65)
...
ax2.axis([-13.0, 15.0, -0.5, 9.0], fontsize=18)
...
plt.tight_layout()
plt.savefig('O17_F17_EOM_2.pdf', format='pdf', bbox_inches='tight')
plt.show()
