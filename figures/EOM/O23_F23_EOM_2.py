...
ax1.axis([-13.0, 15.0, -0.5, 8.0], fontsize=18)
...
ax2.plot([xa[0][1], xa[1][0]], [e4[0][2], e4[1][2]], linestyle=':', color='r', linewidth=1.65)


ax2.axis([-13.0, 15.0, -0.5, 8.0], fontsize=18)
