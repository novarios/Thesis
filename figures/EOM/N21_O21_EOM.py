...
ax1.legend(loc='upper right', frameon=False, fontsize=12, labelspacing=0.0)
...
ax2.annotate(annotation_string, fontsize=20, xy=(0.915, 0.1), xycoords='axes fraction')
plt.setp(ax2, xticks=[-9.0,0.0,9.0], xticklabels=[r'$\beta=0$',r'$\beta=1$',r'$\mathrm{Exp.}$'])

ax2.legend(loc='upper right', frameon=False, fontsize=12, labelspacing=0.0)
