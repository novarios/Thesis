...
filename1 = '/home/sam/Documents/thesis/data/23O_levels.dat'
filename2 = '/home/sam/Documents/thesis/data/PA_final_8_15.dat'
...
filename3 = '/home/sam/Documents/thesis/data/23F_levels.dat'
filename4 = '/home/sam/Documents/thesis/data/PA_final_9_14.dat'
...
#ax1.plot([xa[0][1], xa[1][0]], [e2[0][1], e2[1][1]], linestyle=':', color='r', linewidth=1.65)
...
ax1.axis([-13.0, 15.0, -0.5, 10.5], fontsize=18)
...
#ax2.plot([xa[0][1], xa[1][0]], [e4[0][2], e4[1][1]], linestyle=':', color='b', linewidth=1.65)
#ax2.plot([xa[1][1], xa[3][0]], [e4[1][1], e3[1]], linestyle=':', color='b', linewidth=1.65)

#ax2.plot([xa[0][1], xa[1][0]], [e4[0][3], e4[1][2]], linestyle=':', color='g', linewidth=1.65)
#ax2.plot([xa[1][1], xa[3][0]], [e4[1][2], e3[2]], linestyle=':', color='g', linewidth=1.65)


ax2.axis([-13.0, 15.0, -0.5, 10.5], fontsize=18)
...
plt.tight_layout()
plt.savefig('O23_F23_EOM_2.pdf', format='pdf', bbox_inches='tight')
plt.show()
