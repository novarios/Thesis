...
filename1 = '/home/sam/Documents/thesis/data/PA_new_final_8_9.dat'
filename2 = '/home/sam/Documents/thesis/data/PA_new_final_9_8.dat'
filename3 = '/home/sam/Documents/thesis/data/PA_new_final_8_15.dat'
filename4 = '/home/sam/Documents/thesis/data/PA_new_final_9_14.dat'
...
ax1.plot([0, 30], [-131.762376, -131.762376], '--', color='grey')
ax1.axis([6.0, 30.0, -135.0, -115.0])
...
ax2.plot([0, 30], [-128.219576, -128.219576], '--', color='grey')
ax2.axis([6.0, 30.0, -130.0, -110.0])
...
ax3.plot([0, 30], [-164.760155, -164.760155], '--', color='grey')
ax3.axis([6.0, 30.0, -170.0, -140.0])
...
ax4.plot([0, 30], [-175.313912, -175.313912], '--', color='grey')
ax4.axis([6.0, 30.0, -180.0, -145.0])
...
plt.tight_layout()
plt.savefig('PA-EOM.pdf', format='pdf', bbox_inches='tight')
plt.show()
