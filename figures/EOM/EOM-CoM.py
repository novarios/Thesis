...
plt.plot(hw0_1, e0_1, '-', marker='o', color='k', linewidth=1.65, label=r'$\mathrm{{}^{17}O(5/2^{+})}$')
plt.plot(hw0_2, e0_2, '--', marker='s', color='r', linewidth=1.65, label=r'$\mathrm{{}^{17}F(5/2^{+})}$')
plt.plot(hw0_3, e0_3, ':', marker='^', color='b', linewidth=1.65, label=r'$\mathrm{{}^{23}O(1/2^{+})}$')
plt.plot(hw0_4, e0_4, '-.', marker='v', color='g', linewidth=1.65, label=r'$\mathrm{{}^{23}F(5/2^{+})}$')
...
plt.plot(hw1_1, e1_1, '-', marker='o', color='k', linewidth=1.65, label=r'$\mathrm{{}^{17}O(5/2^{+})}$')
plt.plot(hw1_2, e1_2, '--', marker='s', color='r', linewidth=1.65, label=r'$\mathrm{{}^{17}F(5/2^{+})}$')
plt.plot(hw1_3, e1_3, ':', marker='^', color='b', linewidth=1.65, label=r'$\mathrm{{}^{23}O(1/2^{+})}$')
plt.plot(hw1_4, e1_4, '-.', marker='v', color='g', linewidth=1.65, label=r'$\mathrm{{}^{23}F(5/2^{+})}$')
...
plt.plot(hw0_5, e0_5, '-', marker='o', color='k', linewidth=1.65, label=r'$\mathrm{{}^{15}N(1/2^{-})}$')
plt.plot(hw0_6, e0_6, '--', marker='s', color='r', linewidth=1.65, label=r'$\mathrm{{}^{15}O(1/2^{-})}$')
plt.plot(hw0_7, e0_7, ':', marker='^', color='b', linewidth=1.65, label=r'$\mathrm{{}^{21}N(1/2^{-})}$')
plt.plot(hw0_8, e0_8, '-.', marker='v', color='g', linewidth=1.65, label=r'$\mathrm{{}^{21}O(5/2^{+})}$')
...
plt.plot(hw1_5, e1_5, '-', marker='o', color='k', linewidth=1.65, label=r'$\mathrm{{}^{15}N(1/2^{-})}$')
plt.plot(hw1_6, e1_6, '--', marker='s', color='r', linewidth=1.65, label=r'$\mathrm{{}^{15}O(1/2^{-})}$')
plt.plot(hw1_7, e1_7, ':', marker='^', color='b', linewidth=1.65, label=r'$\mathrm{{}^{21}N(1/2^{-})}$')
plt.plot(hw1_8, e1_8, '-.', marker='v', color='g', linewidth=1.65, label=r'$\mathrm{{}^{21}O(5/2^{+})}$')
