...
ax1.plot([xa[0][1], xa[1][0]], [e2[0][0], e2[1][0]], linestyle=':', color='g', linewidth=2.5)
ax1.plot([xa[1][1], xa[3][0]], [e2[1][0], e1[0]], linestyle=':', color='g', linewidth=2.5)

ax1.plot([xa[0][1], xa[1][0]], [e2[0][1], e2[1][1]], linestyle=':', color='b', linewidth=2.5)
ax1.plot([xa[1][1], xa[3][0]], [e2[1][1], e1[1]], linestyle=':', color='b', linewidth=2.5)
...
ax1.axis([-13.0, 15.0, -0.5, 9.0], fontsize=22)
...
ax2.plot([xa[0][1], xa[1][0]], [e4[0][1], e4[1][1]], linestyle=':', color='b', linewidth=2.5)
...
ax2.axis([-13.0, 15.0, -0.5, 9.0], fontsize=22)
