...
filename1 = '/home/sam/Documents/thesis/data/Ground_State_2_2.dat'
filename2 = '/home/sam/Documents/thesis/data/Ground_State_8_8.dat'
filename3 = '/home/sam/Documents/thesis/data/Ground_State_20_20.dat'
filename4 = '/home/sam/Documents/thesis/data/Ground_State_28_28.dat'
...
ax1.plot([0, 30], [-28.2957, -28.2957], '--', color='grey')
ax1.axis([6.0, 30.0, -28.5, -25.0])
plt.setp(ax1.get_xticklabels(), visible=False)
ax1.set_ylabel(r'$\mathrm{E\ (MeV)}$', fontsize=15)
# 28.2957
annotation_string = r'$\mathrm{^{4}He}$'
...
ax3.plot([0, 30], [-342.052, -342.052], '--', color='grey')
ax3.axis([6.0, 30.0, -375.0, -325.0])
...
ax4.plot([0, 30], [-483.996, -483.996], '--', color='grey')
ax4.axis([6.0, 30.0, -545.0, -430.0])
ax4.set_xlabel(r'$\mathrm{\hbar\omega\ (MeV)}$', fontsize=15)
# 483.996
annotation_string = r'$\mathrm{^{56}Ni}$'
...
plt.tight_layout()
plt.savefig('ground_state1.pdf', format='pdf', bbox_inches='tight')
plt.show()
