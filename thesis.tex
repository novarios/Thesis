...
\newcommand{\ket}[1]{\hspace{1pt}| #1 \rangle}
...
\newcommand{\co}[1]{\hat{#1}^{\dagger}}
\newcommand{\ao}[1]{\hat{#1}^{}}
...
\chapter{Equation-of-Motion Method}
\subfile{EOM}

\chapter{Effective Operators}
