...
\end{table}
It should be stated that while Gamow-Teller transitions can occur without a change in the nuclear spin ($\Delta J = 0\ \text{for}\ J_{F}>0\ \text{and}\ J_{I}>0$), the Gamow-Teller operator carries an angular momentum of $J = 1$.
...
\begin{gather}
  B_{F} = \frac{g_{V}^{2}}{2J_{\mathrm{i}} + 1}\delta_{J_\mathrm{f}J_{\mathrm{i}}}\sum_{\mathrm{f}}\relement{\Ref}{\Lop_{\mathrm{i}}\EOop{}_{F^{\pm}}\Rop_{\mathrm{f}}}{\Ref}\relement{\Ref}{\Lop_{\mathrm{f}}\EOop{}_{F^{\mp}}\Rop_{\mathrm{i}}}{\Ref}, \\
  B_{GT} = \frac{g_{A}^{2}}{2J_{\mathrm{i}} + 1}\sum_{\mathrm{f}}\relement{\Ref}{\Lop_{\mathrm{i}}\EOop{}_{GT^{\pm}}\Rop_{\mathrm{f}}}{\Ref}\relement{\Ref}{\Lop_{\mathrm{f}}\EOop{}_{GT^{\mp}}\Rop_{\mathrm{i}}}{\Ref}.
\end{gather}
