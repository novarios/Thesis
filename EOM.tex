...
\end{align}
\begin{align}
  \omega_{k}\rop{a}{} &= \sum\limits_{c}\xint{a}{c}\rop{c}{} + \sum\limits_{kc}\xint{k}{c}\rop{ac}{k} - \frac{1}{2}\sum\limits_{kcd}\xint{ka}{cd}\rop{cd}{k} \notag \\
  \omega_{k}\rop{a}{} &= \xint{a}{c}\rop{c}{} + \rop{a}{k\bar{c}}\xint{k\bar{c}}{} - \frac{1}{2}\xint{a}{cd\bar{k}}\rop{cd\bar{k}}{} \notag \\
  \omega_{k}\rop{}{} &\leftarrow \xint{}{\text{pp}3}\rop{}{} + \rop{}{2_{1}}\xint{}{\text{hp}2} - \frac{1}{2}\xint{}{\text{hppp}3_{2}}\rop{}{3_{4}} \notag \\
\end{align}
\begin{align}
...
\end{align}
\begin{align}
  \omega_{k}\rop{ab}{i} &= -\sum\limits_{c}\xint{ab}{ic}\rop{c}{} + \Perm{ab}\sum\limits_{c}\xint{b}{c}\rop{ac}{i} - \sum\limits_{k}\xint{k}{i}\rop{ab}{k} + \frac{1}{2}\sum\limits_{cd}\xint{ab}{cd}\rop{cd}{i} \notag \\
  &-\Perm{ab}\sum\limits_{kc}\xint{ka}{ic}\rop{cb}{k} - \frac{1}{2}\sum\limits_{klcd}\vint{kl}{cd}\amp{ab}{ki}\rop{cd}{l} \notag \\
  \omega_{k}\rop{ab}{i} &= -\xint{ab\bar{i}}{c}\rop{c}{} + \Perm{ab}\xint{b}{c}\rop{c}{i\bar{a}} - \rop{ab}{k}\xint{k}{i} + \frac{1}{2}\xint{ab}{cd}\rop{cd}{i} \notag \\
  &-\Perm{ab}\rop{b}{k\bar{c}}\xint{k\bar{c}}{i\bar{a}}  - \frac{1}{2}\amp{ab\bar{i}}{k}\vint{k}{cd\bar{l}}\rop{cd\bar{l}}{} \notag \\
  \omega_{k}\rop{}{3} &\leftarrow -\xint{}{\text{pphp}3_{4}}\rop{}{} - \frac{1}{2}\amp{}{3_{3}}\vint{}{\text{hhpp}3_{1}}\rop{}{3} \notag \\
  \omega_{k}\rop{}{3_{2}} &\leftarrow \xint{}{\text{pp}3}\rop{}{3_{2}} - \rop{}{3_{2}}\xint{}{\text{hphp}2_{1}} \notag \\
  \omega_{k}\rop{}{3_{1}} &\leftarrow -\xint{}{\text{pp}3}\rop{}{3_{2}} + \rop{}{3_{2}}\xint{}{\text{hphp}2_{1}} \notag \\
  \omega_{k}\rop{}{1} &\leftarrow -\rop{}{1}\xint{}{\text{hh}3} + \frac{1}{2}\xint{}{\text{pppp}1}\rop{}{1}
\end{align}
\begin{align}
...
\end{align}
\begin{align}
  E_{k}\lop{}{a} &= \sum\limits_{c}\lop{}{c}\xint{c}{a} - \frac{1}{2}\sum\limits_{kcd}\lop{k}{cd}\xint{cd}{ka} \notag \\
  E_{k}\lop{}{a} &= \lop{}{c}\xint{c}{a} - \frac{1}{2}\lop{}{cd\bar{k}}\xint{cd\bar{k}}{a} \notag \\
  E_{k}\lop{}{} &\leftarrow \lop{}{}\xint{}{\text{pp}3} - \frac{1}{2}\lop{}{3}\xint{}{\text{pphp}3_{4}}
\end{align}
\begin{align}
...
\end{align}
\begin{align}
  E_{k}\lop{i}{ab} &= \Perm{ab}\lop{}{a}\xint{i}{b} - \sum\limits_{c}\lop{}{c}\xint{ic}{ab} - \sum\limits_{k}\lop{k}{ab}\xint{i}{k} + \Perm{ab}\sum\limits_{c}\lop{i}{ac}\xint{c}{b} \notag \\
  &+ \frac{1}{2}\sum\limits_{cd}\lop{i}{cd}\xint{cd}{ab} - \Perm{ab}\sum\limits_{kc}\lop{k}{cb}\xint{ic}{ka} - \frac{1}{2}\sum\limits_{klcd}\lop{l}{cd}\vint{ki}{ab}\amp{cd}{kl} \notag \\
  E_{k}\lop{i}{ab} &= \Perm{ab}\lop{}{a}\xint{i\bar{b}}{} - \lop{}{c}\xint{c}{ab\bar{i}} - \xint{i}{k}\lop{k}{ab} + \Perm{ab}\lop{i\bar{a}}{c}\xint{c}{b} \notag \\
  &+ \frac{1}{2}\lop{i}{cd}\xint{cd}{ab} - \Perm{ab}\xint{i\bar{a}}{k\bar{c}}\lop{k\bar{c}}{b} - \frac{1}{2}\lop{}{cd\bar{l}}\amp{cd\bar{l}}{k}\vint{k}{ab\bar{i}} \notag \\
  E_{k}\lop{}{3} &\leftarrow -\lop{}{}\xint{}{\text{hppp}3_{2}} - \frac{1}{2}\lop{}{3}\amp{}{3_{3}}\vint{}{\text{hhpp}3_{1}} \notag \\
  E_{k}\lop{}{3_{2}} &\leftarrow -\lop{}{}\xint{}{\text{hp}2} + \lop{}{3_{2}}\xint{}{\text{pp}3} - \xint{}{\text{hphp}2_{1}}\lop{}{3_{2}} \notag \\
  E_{k}\lop{}{3_{1}} &\leftarrow \lop{}{}\xint{}{\text{hp}2} - \lop{}{3_{2}}\xint{}{\text{pp}3} + \xint{}{\text{hphp}2_{1}}\lop{}{3_{2}} \notag \\
  E_{k}\lop{}{1} &\leftarrow -\xint{}{\text{hh}3}\rop{}{1} + \frac{1}{2}\lop{}{1}\xint{}{\text{pppp}1}
\end{align}
